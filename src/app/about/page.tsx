        ...
        <div className="container-tight relative z-10 px-6">
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <div className="space-y-6 text-lg text-black leading-relaxed max-w-3xl mx-auto">
                <p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 lg:gap-24">
            ...
            >
              ...
              <div className="pt-8 grid grid-cols-1 gap-4">
                <div className="flex items-center gap-4 p-4 rounded-xl bg-primary/5 border border-primary/10 transition-colors hover:bg-primary/10">
                  <div className="h-8 w-8 rounded-lg bg-white flex items-center justify-center shadow-sm">
                    <Sparkles className="h-4 w-4 text-primary" />
                  </div>
                  <span className="font-bold text-sm uppercase tracking-wider">Radical Awareness</span>
                </div>
                <div className="flex items-center gap-4 p-4 rounded-xl bg-primary/5 border border-primary/10 transition-colors hover:bg-primary/10">
                  <div className="h-8 w-8 rounded-lg bg-white flex items-center justify-center shadow-sm">
                    <Target className="h-4 w-4 text-primary" />
                  </div>
                  <span className="font-bold text-sm uppercase tracking-wider">Technological Ethics</span>
                </div>
                <div className="flex items-center gap-4 p-4 rounded-xl bg-primary/5 border border-primary/10 transition-colors hover:bg-primary/10">
                  <div className="h-8 w-8 rounded-lg bg-white flex items-center justify-center shadow-sm">
                    <User className="h-4 w-4 text-primary" />
                  </div>
                  <span className="font-bold text-sm uppercase tracking-wider">Human-Centric Design</span>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="space-y-4 text-lg text-black leading-relaxed">
                ...
                <div className="pt-2">
                  <p className="font-bold text-black">We do not chase noise.</p>
            ...
            >
              ...
              <div className="grid grid-cols-1 gap-6 pt-4">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-black">In-depth Articles</h4>
                    <p className="text-black/60 text-sm">Clarity on complex topics.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <Book className="h-6 w-6 text-primary shrink-0" />
                  <div>
                    <h4 className="font-bold text-black">Books & Guides</h4>
                    <p className="text-black/60 text-sm">Long-form knowledge for deeper growth.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <Youtube className="h-6 w-6 text-primary shrink-0" />
                  <div>
                    <h4 className="font-bold text-black">Videos & Podcasts</h4>
                    <p className="text-black/60 text-sm">Ideas that inform, inspire, and provoke thought.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <Code className="h-6 w-6 text-primary shrink-0" />
                  <div>
                    <h4 className="font-bold text-black">Technology Solutions</h4>
                    <p className="text-black/60 text-sm">Building tools and platforms that empower creators and communities.</p>
                  </div>
                </div>
              </div>
            </motion.div>
              ...
              <div className="mt-auto pt-12">
                ...
                >
                  ...
                  <div className="space-y-1">
                    <p className="font-playfair text-lg text-black/80">Timeless wisdom. Modern perspective.</p>
                    <p className="font-bold text-black">Stronger future.</p>
                  </div>
                </motion.div>
              </div>
            </motion.div>
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            <div className="flex items-center gap-8 text-black">
              <div className="text-center lg:text-left">
                <p className="text-sm font-bold tracking-widest uppercase text-black mb-1">Exploring today.</p>
                <p className="text-xl font-playfair italic">Understanding tomorrow.</p>
              </div>
              <div className="w-px h-12 bg-border hidden lg:block" />
              <p className="max-w-md text-black leading-relaxed hidden lg:block">
