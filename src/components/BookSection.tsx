  ...
  return (
    <section className="relative overflow-hidden bg-[#2B4A4A] py-20 lg:py-32" id="books">
      ...
      <div className="container-tight relative z-10 px-6 sm:px-10 lg:px-16">
        <div className="flex flex-col lg:grid lg:grid-cols-[1.3fr_0.7fr] gap-12 lg:gap-24 items-center">
          ...
          >
            <div className="relative group">
              ...
              <motion.div 
                ...
                className="relative w-full max-w-[400px] sm:max-w-[550px] lg:max-w-[700px] aspect-[3/4.5] shadow-[40px_40px_80px_-15px_rgba(0,0,0,0.8)] rounded-r-sm overflow-hidden transform-gpu"
              >
                <img
                  src={mainBook.image}
                  alt={mainBook.title}
          ...
          <motion.div
            ...
            className="text-white order-1 lg:order-2 max-w-[380px]"
          >
